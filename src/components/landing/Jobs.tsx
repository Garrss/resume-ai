...
export default function Jobs() {
    ...
    return (
        <section className="relative w-full min-h-screen py-12">
            ...
            <div className="absolute top-16 left-1/4 w-56 h-56 bg-gradient-to-r from-primary/20 to-primary/10 rounded-full blur-3xl pointer-events-none" />
            <div className="absolute bottom-0 right-1/4 w-72 h-72 bg-gradient-to-r from-primary/15 to-primary/5 rounded-full blur-3xl pointer-events-none" />
